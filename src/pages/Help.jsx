...
function Help() {
  useEffect(() => {
    ...
    const handleTabClick = (event, linkId) => {
      event.preventDefault(); // Заборона стандартної дії кліку (прокручування сторінки)
    ...
    allLinks.forEach((elem) => {
      elem.addEventListener('click', (event) => handleTabClick(event, elem.id));
    });
    ...
    <div className="tabs-container">
        <ul className="tabs">
            <li>
                <a id="tab1" title="Your Idea & Vision" href="#tab1">
                    <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-bulb" width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
            ...
            <li>
                <a id="tab3" title="UX/UI Design" href="#tab3">
                    <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-brush" width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
            ...
            <li>
                <a id="tab6" title="MVP Release & Iterations" href="#tab6">
                    <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-rocket" width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
        ...
        <div className="tab-content-wrapper">
            <section id="tab1-content" className="tab-content">
                ...
                <img src="assetsHelp/idea.png" alt="idea" />
            </section>
            <section id="tab2-content" className="tab-content">
                ...
                <img src="assetsHelp/product.png" alt="product" /> 
            </section> 
            <section id="tab3-content" className="tab-content">
                ...
                <img src="assetsHelp/ui.png" alt="ui" /> 
            </section>
            <section id="tab4-content" className="tab-content">
                ...
                <img src="assetsHelp/brain.png" alt="brain" /> 
            </section>
            <section id="tab5-content" className="tab-content">
                ...
                <img src="assetsHelp/engineer.png" alt="engineer" /> 
            </section>
            <section id="tab6-content" className="tab-content">
                ...
                <img src="assetsHelp/release.png" alt="release" /> 
            </section>
        </div>
    </div>
);
